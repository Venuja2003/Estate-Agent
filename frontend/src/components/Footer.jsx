        ...
        <footer className="footer">
            <div className="footer-content">
                <div className="footer-section footer-about">
                    <h3 className="footer-logo">Property<span>Finder</span></h3>
                    <p className="footer-description">
                        Your trusted partner in finding the perfect property.
                        Search, explore, and discover your dream home with ease.
                    </p>
                ...
                <div className="footer-section footer-links">
                    ...
                    <ul className="footer-list">
                        ...
                        <li><a href="#" className="footer-link">Land</a></li>
                        <li><a href="#" className="footer-link">New Builds</a></li>
                    </ul>
                </div>
                ...
                <div className="footer-section footer-contact">
                    ...
                    <div className="contact-item">
                        ...
                        <span>123 Property Street<br/>London, UK</span>
                    </div>
                    <div className="contact-item">
                        <span className="contact-icon">📞</span>
